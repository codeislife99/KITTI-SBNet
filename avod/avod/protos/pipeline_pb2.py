...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[model_pb2.DESCRIPTOR,train_pb2.DESCRIPTOR,eval_pb2.DESCRIPTOR,kitti_dataset_pb2.DESCRIPTOR,])
...
_NETWORKPIPELINECONFIG.fields_by_name['model_config'].message_type = model_pb2._MODELCONFIG
_NETWORKPIPELINECONFIG.fields_by_name['train_config'].message_type = train_pb2._TRAINCONFIG
_NETWORKPIPELINECONFIG.fields_by_name['eval_config'].message_type = eval_pb2._EVALCONFIG
_NETWORKPIPELINECONFIG.fields_by_name['dataset_config'].message_type = kitti_dataset_pb2._KITTIDATASETCONFIG
