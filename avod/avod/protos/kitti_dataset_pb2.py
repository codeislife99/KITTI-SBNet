...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  dependencies=[kitti_utils_pb2.DESCRIPTOR,])
...
_KITTIDATASETCONFIG.fields_by_name['kitti_utils_config'].message_type = kitti_utils_pb2._KITTIUTILSCONFIG
