...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  dependencies=[mini_batch_pb2.DESCRIPTOR,])
...
_KITTIUTILSCONFIG.fields_by_name['mini_batch_config'].message_type = mini_batch_pb2._MINIBATCHCONFIG
