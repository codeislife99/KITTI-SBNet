...
class unet(nn.Module):
    ...
    def __init__(self):
        ...
        #Convolution 1
        self.conv1=nn.Conv2d(in_channels=6,out_channels=16, kernel_size=5,stride=1, padding=2)
        ...
        #DeConvolution 3
        self.deconv3=nn.ConvTranspose2d(in_channels=22,out_channels=1,kernel_size=5,padding=2)
